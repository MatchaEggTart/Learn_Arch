...
# 定义资源文件位置
appimage_source="WeChatLinux_x86_64.AppImage"
appimage_company="tencent"
appimage_name="wechat"
desktop_file="${script_dir}/$appimage_name/wechat.desktop"
icon_file="${script_dir}/$appimage_name/icons/wechat.png"
install_dir="/opt/$appimage_company/$appimage_name"
desktop_dir="$HOME/.local/share/applications/wechat.desktop"
icon_dir="$install_dir/icons/wechat.png"
