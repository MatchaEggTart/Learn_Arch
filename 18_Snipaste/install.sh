...
# 定义资源文件位置
appimage_source="Snipaste-2.10.8-x86_64.AppImage"
appimage_company="microsoft/snipaste"
appimage_name="snipaste"
desktop_file="${script_dir}/$appimage_name/snipaste.desktop"
icon_file="${script_dir}/$appimage_name/icons/snipaste.png"
install_dir="/opt/$appimage_company/$appimage_name"
desktop_dir="$HOME/.local/share/applications/snipaste.desktop"
icon_dir="$install_dir/icons/snipaste.png"
...
# sudo mkdir -p /opt/microsoft/snipaste/icons
# sudo cp $HOME/Downloads/Snipaste-2.10.8-x86_64.AppImage /opt/microsoft/snipaste
# sudo cp $HOME/Workspace/Learn_Arch/Snipaste/snipaste.png /opt/microsoft/snipaste/icons/
# sudo cp $HOME/Workspace/Learn_Arch/Snipaste/snipaste.desktop $HOME/.local/share/applications/
# cd /opt/microsoft/snipaste
